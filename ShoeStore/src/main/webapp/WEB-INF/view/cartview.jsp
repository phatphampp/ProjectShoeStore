            ...
            <nav class="navbar navbar-expand-lg navbar navbar-dark bg-primary">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse2">
                    <div class="navbar-nav">
                        <a href="/ShoeStore/product/list.html" class="nav-item nav-link">Products</a>
                        <a href="/ShoeStore/cart.html" class="nav-item nav-link active">Cart</a>
                    </div>
                    <c:choose>
                    ...
                    <div class="table-wrapper">
                        <div class="table-title">
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <a href="/ShoeStore/cart/payment.html" class="btn btn-secondary"><i class="material-icons">&#xE147;</i> <span>Payment</span></a>						
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="clearfix">
                            <ul class="pagination">
                                <li class="page-item disabled"><b>Total = ${total}</b></li>
                            </ul>
                        </div>
                    </div>
                </div>
